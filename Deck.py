...
S4 = card("S4", "assets/S4.png", 5, 3, 0, "support") # Why is bro so strong
...
P1 = card("P1", "assets/P1.png", 1, 0, 0, "passive") # 2x Damage
P2 = card("P2", "assets/P2.png", 1, 0, 0, "passive") # +1 HP
# P3 = card("P3", "assets/P3.png", 1, 0, 0, "passive") # +2 Def
P4 = card("P4", "assets/P4.png", 1, 0, 0, "passive") # +2 Atk
deck += [P1, P2, P4] # P3 removed
EA2 = card("EA2", "assets/EA2.png", 2, 4, 0, "attack")
Catastrophevil = card("Catastrophevil", "assets/Catastrophevil.png", 2, 5, 0, "attack")
ES4 = card("ES4", "assets/ES4.png", 5, 3, 0, "support")
ES5 = card("ES5", "assets/ES5.png", 6, 1, 0, "support")
EP1 = card("EP1", "assets/EP1.png", 1, 0, 0, "passive") # !!!Actually EP4!!! W A R N I N G !!!! W A R N I N G !!!!!
EP2 = card("EP2", "assets/EP2.png", 1, 0, 0, "passive") # +1 HP
